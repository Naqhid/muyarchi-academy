  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "We'll contact you to schedule your free demo class soon.",
      })
      setFormData({
        studentName: '',
        class: '',
      ...
      <section className="relative flex min-h-[50vh] items-center justify-center overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-primary">
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            Experience our teaching methodology firsthand. No commitment, just quality education.
          </p>
        </motion.div>
      </section>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={handleChange}
                      required
                      placeholder="e.g., Morning 10 AM, Afternoon 3 PM, Evening 6 PM"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      onChange={handleChange}
                      placeholder="Any specific subjects or topics you'd like to cover in the demo?"
                    />
                  </div>
